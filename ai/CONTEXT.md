...
4. Next: partial-dependency and cross-claim evidence cases, simultaneous unknown/contradiction cases, valid degraded-operation cases, and false-permission/false-refusal measured separately - before any comparison against a stronger conservative-fusion baseline or any larger build.
