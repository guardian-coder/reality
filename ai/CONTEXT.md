...
18. A public narrative website was selected as the place to show the research journey and make every major claim traceable to evidence. The first build attempt on 2026-09-05 was blocked by the workspace dependency-security policy (`EALLOWSCRIPTS`) while invoking the required official Sites scaffold. The policy was not bypassed; no site files or deployment were created.
