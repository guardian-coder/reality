...
Trusted Execution concerns the path:

> Principal → delegated mandate → constraints → authorized action → execution evidence → resulting state

It may become critical when autonomous systems act across organizational boundaries.

## Unresolved relationship

No conclusion has been reached on whether:

- truth is the primitive and authority is a consumer;
- authority/execution is the primitive and truth is an input/output;
