...
- [2026-09-04 — Dependency Semantics Forcing Counterexamples](../validation/2026-09-04_DEPENDENCY_SEMANTICS_FORCING_CASES.md) — Paired tests show string-equality dependencies create a false refusal when a shared failure is irrelevant to the claim property, while visibility alone cannot enforce a blocking identity-position dependency across claims.
