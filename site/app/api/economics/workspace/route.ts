import { createWorkspace, loadOverview, workspaceForOwner } from '@/lib/economic-store';
...
export async function POST(request: Request) {
  ...
  const result = await createWorkspace(user.userId, String(payload.name || 'My agent operations'));
